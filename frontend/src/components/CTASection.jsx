    ...
    return (
        <section className="py-12 sm:py-16 md:py-24 bg-slate-900 overflow-hidden relative">
            ...
            <div className="w-full px-4 sm:px-6 relative z-10 text-center">
                ...
                >
                    <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 sm:mb-6">Ready to Break the Silence?</h2>
                    <p className="text-base sm:text-lg md:text-xl text-slate-300 max-w-2xl mx-auto mb-6 sm:mb-8 md:mb-10">
